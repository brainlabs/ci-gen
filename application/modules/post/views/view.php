...
<section class="panel panel-default">
    <header class="panel-heading">
        <div class="row">
            ...
            <div class="col-md-4 col-xs-9">
                 ...
                 <?php echo form_open(site_url('post/search'), 'role="search" class="form"') ;?>       
    ...
    <div class="panel-body">
         <?php if ($posts) : ?>
              ...
              <tr>
               ...
               <td><?php echo $post['user_id']; ?></td>
                ...
                <td>    
                    ...
                    <?php
                                  echo anchor(
                                          site_url('post/show/' . $post['post_id']),
                   ...
                   ?>
                    ...
                    <?php
                                  echo anchor(
                                          site_url('post/edit/' . $post['post_id']),
                   ...
                   <?php
                                  echo anchor(
                                          site_url('post/destroy/' . $post['post_id']),
          ...
          <?php else: ?>
                <?php  echo notify('Data post belum tersedia','info');?>
          <?php endif; ?>
    </div>
