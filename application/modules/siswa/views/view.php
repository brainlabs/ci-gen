...
<section class="panel panel-default">
    <header class="panel-heading">
        <div class="row">
            ...
            <div class="col-md-4 col-xs-9">
                 ...
                 <?php echo form_open(site_url('siswa/search'), 'role="search" class="form"') ;?>       
    ...
    <div class="panel-body">
         <?php if ($siswas) : ?>
              ...
              <tr>
               ...
               <td><?php echo $siswa['tanggal_lahir']; ?></td>
                ...
                <td>    
                    ...
                    <?php
                                  echo anchor(
                                          site_url('siswa/show/' . $siswa['siswa_id']),
                   ...
                   ?>
                    ...
                    <?php
                                  echo anchor(
                                          site_url('siswa/edit/' . $siswa['siswa_id']),
                   ...
                   <?php
                                  echo anchor(
                                          site_url('siswa/destroy/' . $siswa['siswa_id']),
          ...
          <?php else: ?>
                <?php  echo notify('Data siswa belum tersedia','info');?>
          <?php endif; ?>
    </div>
