...
<div class="panel panel-primary">
    <div class="panel-heading"><i class="glyphicon glyphicon-signal"></i> </div>
      ...
      <div class="panel-body">
         <?php echo form_open(site_url('jurnals'),'role="form" class="form-horizontal" id="form_jurnals"'); ?>
                  ...
                  <?php                  
                   echo form_input(
                                array(
                                 ...
                                 set_value('operator_id',$table['operator_id'])
                           );             
                  ?>
                  ...
                  <?php                  
                   echo form_input(
                                array(
                                 ...
                                 set_value('tanggal',$table['tanggal'])
                           );             
                  ?>
